...
SUBDIR+=	json2tsv-git
SUBDIR+=	jsoncpp-git
SUBDIR+=	jsonnet-bundler
SUBDIR+=	jsonrpc-glib
SUBDIR+=	judy
SUBDIR+=	julia
SUBDIR+=	junit
SUBDIR+=	jupyter-xeus-kernels
SUBDIR+=	just
SUBDIR+=	jython
SUBDIR+=	jzintv
SUBDIR+=	k9s
